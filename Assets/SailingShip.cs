...
public class SailingShip : MonoBehaviour {
    ...
    public void Sail() {
        ...
        story_controller.ShowText("You survived the island! Made for LudumDare 38 by Linkpact Games", this.gameObject, button_prompt: true, yes_event: StoryEvent.Restart);
    }
}
